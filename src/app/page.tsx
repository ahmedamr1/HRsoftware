...
import { Building2, Plus, Search, Sparkles, Brain, Users, TrendingDown, ShieldAlert, Activity, Calendar as CalendarIcon, Zap, ArrowUpRight, CheckCircle2, Info, Clock, Trophy, MessageSquare, ClipboardList, TrendingUp, Eye, EyeOff, Laptop } from "lucide-react";
  ...
  return (
    <div className="space-y-6 text-left pb-10">
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
        ...
        {/* Column 2: Contextual History/Activity */}
        <Card className="bg-white/50 dark:bg-zinc-950/50 backdrop-blur-xl border-zinc-200 dark:border-zinc-800 shadow-xl overflow-hidden h-full">
        ...
        {/* Column 3: Contextual Progress/Pulse */}
